...
Sprite::Sprite(Entity *e, float size, float height, float red, float green, float blue, float alpha, GLuint texid) : Object(e), texid(texid)
{
  totalVertex = 4;
  totalIndexes = 4;
  ...
  vertices[0].tex[U_POS]      = 0.3f;
  vertices[0].tex[V_POS]      = 0.3f;
  ...
  vertices[2].tex[U_POS]      = 0.f;
  vertices[2].tex[V_POS]      = 0.f;
